        ...
        <div className={s.content_our}>
          <div className={s.item}>
            ...
            <p className={s.item_text_decor}>
                Наш информационный сайт всегда открыт для вас! Вы можете найти полезную информацию о приютах Узбекистана, получить ответы на вопросы и узнать, как помочь, в любое время.
            </p>
          </div>
          <div className={s.item}>
            <h2 className={s.item_text_desc}>Актуальные данные</h2>
            <p className={s.item_text_decor}>
                Мы предоставляем точную и свежую информацию о работе приютов, условиях проживания, а также возможностях волонтёрства и поддержки.
            </p>
          </div>
          <div className={s.item}>
            <h2 className={s.item_text_desc}>Поддержка и безопасность</h2>
            <p className={s.item_text_decor}>
                Наша цель – создать ресурс, где каждый сможет найти нужные сведения и почувствовать заботу. Мы следим за тем, чтобы все материалы были проверенными, а общение – доброжелательным и полезным.
            </p>
          </div>
        </div>
      </section>
